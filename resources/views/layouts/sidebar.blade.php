        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                 ...
                 <li class="sidebar-item">
                    <a href="{{ route('masters.index') }}" class="sidebar-link">
                        <i class="mdi mdi-account-plus"></i>
                        <span class="hide-menu">-- View Masters</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('categories.index') }}" class="sidebar-link">
                        <i class="mdi mdi-account-plus"></i>
                        <span class="hide-menu">-- View File Types</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('classifications.index') }}" class="sidebar-link">
                        <i class="mdi mdi-account-plus"></i>
                        <span class="hide-menu">-- View Classifications</span>
                    </a>
                </li>
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                 <a href="{{ route('deferred_list.files') }}" class="sidebar-link">
                    <i class="mdi mdi-account-plus"></i>
                    <span class="hide-menu">-- Overdue</span>
                    <span class="badge m-l-5 badge-pill badge-info noti">{{ $verification_requests }}</span>
                 </a>
                </li>
                 <li class="sidebar-item">
                 <a href="#" class="sidebar-link">
                    <i class="mdi mdi-account-plus"></i>
                    <span class="hide-menu">-- Marked</span>
                    <span class="badge m-l-5 badge-pill badge-info noti">{{ $verification_requests }}</span>
                 </a>
                </li>
                 <li class="sidebar-item">
