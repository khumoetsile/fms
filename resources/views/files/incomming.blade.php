    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Recieved</h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Recieved</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Recieved</h4>
                        <hr>
                        <div class="row">
                            <div class="col-12">
                                @if(session('gmsg'))
                                ...
                                <table id="zero_config" class="table nowrap table-striped table-bordered table-sm m-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><small><font>{{ $file->created_at }}</font></small></td>
                                            ...
                                            -->
                                                <a href="{{ route('accept.files', $file->id) }}" type="button" class="btn btn-block btn-success btn-single-submit" role="button"><i class="fas fa-edit"></i> Accept</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
