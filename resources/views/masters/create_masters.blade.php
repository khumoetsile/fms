...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Add Master</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Add Master</h4>
					<div class="row">
						<div class="col-12">
							@if(session('gmsg'))
                    ...
                    <form class="form-single-submit" action="{{ route('masters.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('master_code') is-invalid @enderror" value="{{ old('master_code') }}" id="master_code" name="master_code" placeholder="Enter Master code..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('master_name') is-invalid @enderror" value="{{ old('master_name') }}" id="master_name" name="master_name" placeholder="Enter Master name..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" name="submit_masters" id="submit_masters" value="1">
