                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">File Types</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2">
                                <a href="{{ route('categories.create') }}" type="button" class="btn btn-block btn-sm btn-info" role="button">Add File Type</a>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <a href="{{ route('categories.upload_page') }}" type="button" class="btn btn-block btn-sm btn-warning btn-single-submit" role="button">Upload File Type</a>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <a href="#" id="categories_export" type="button" class="btn btn-block btn-sm btn-success btn-single-submit" role="button">Export File Types</a>
                            </div>
                            <div class="col-lg-2 col-md-2">
                                <a href="{{ route('categories.show_deleted') }}" type="button" class="btn btn-block btn-sm btn-danger btn-single-submit" role="button">Deleted File Types</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
