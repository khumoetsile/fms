                    ...
                    <form class="form-single-submit" action="{{ route('classifications.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('classification_code') is-invalid @enderror" value="{{ old('classification_code') }}" id="classification_code" name="classification_code" placeholder="Enter Classification code..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('classification_name') is-invalid @enderror" value="{{ old('classification_name') }}" id="classification_name" name="classification_name" placeholder="Enter Classification name..." required>
