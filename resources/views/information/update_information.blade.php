        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('information.update', $information->id) }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="about_label">|About Label<span style="color:red"> *</span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('about_label') is-invalid @enderror" id="about_label" name="about_label" value="{{ $information->about_label }}" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="about_value">About Value<span style="color:red"> *</span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('about_value') is-invalid @enderror" id="about_value" name="about_value" value="{{ $information->about_value }}" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="about_status">About Status<span style="color:red"> *</span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <select name="about_status" class="form-control form-control-sm @error('about_status') is-invalid @enderror" id="about_status" required>
                                    ...
                                    <option value="1"@if($information->about_status == 1){{ 'selected' }}@endif>Active</option>
                                    <option value="0"@if($information->about_status == 0){{ 'selected' }}@endif>Disabled</option>
