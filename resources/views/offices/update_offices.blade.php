        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('offices.update', $office->id) }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('office_code') is-invalid @enderror" id="office_code" name="office_code" value="{{ $office->office_code }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('office_name') is-invalid @enderror" id="office_name" name="office_name" value="{{ $office->office_name }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <select name="office_status" class="form-control form-control-sm @error('office_status') is-invalid @enderror" id="office_status" required>
                                    ...
                                    <option value="1"@if($office->office_status == 1){{ 'selected' }}@endif>Active</option>
                                    <option value="0"@if($office->office_status == 0){{ 'selected' }}@endif>Disabled</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" name="submit_office" id="submit_office" value="1">
