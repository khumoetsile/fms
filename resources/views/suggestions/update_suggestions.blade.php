    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Edit Suggestion</h4>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('suggestions.update', $suggestion->id) }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('suggestion_code') is-invalid @enderror" id="suggestion_code" name="suggestion_code" value="{{ $suggestion->suggestion_code }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('suggestion_name') is-invalid @enderror" id="suggestion_name" name="suggestion_name" value="{{ $suggestion->suggestion_name }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <select name="suggestion_status" class="form-control form-control-sm @error('suggestion_status') is-invalid @enderror" id="suggestion_status" required>
                                    ...
                                    <option value="1"@if($suggestion->suggestion_status == 1){{ 'selected' }}@endif>Active</option>
                                    <option value="0"@if($suggestion->suggestion_status == 0){{ 'selected' }}@endif>Disabled</option>
