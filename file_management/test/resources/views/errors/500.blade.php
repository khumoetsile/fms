    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <h1 class="text-uppercase error-subtitle">INTERNAL SERVER ERROR !</h1>
                <h1 class="text-muted m-t-30 m-b-30">PLEASE TRY AFTER SOME TIME</h1>
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <a href="{{ url('/') }}" class="btn btn-lg btn-info btn-rounded waves-effect waves-light m-b-40">Back to Home</a>
                    </div>
            </div>
        </div>
        <!-- ============================================================== -->
