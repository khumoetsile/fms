            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('contacts.update', $contact->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="contact_address3">Contact Address3 <span style="color:red"></span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" style="text-transform:uppercase" class="form-control" id="contact_address3" name="contact_address3" value="{{ $contact->contact_address3 }}">
                                @if($errors->has('contact_address3'))
                                <strong class="text-danger">{{ $errors->first('contact_address3') }}</strong>
                                @endif
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input maxlength="10" type="text" class="form-control" id="area_name" name="area_name" value="{{ $contact->area_name }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input maxlength="10" type="text" class="form-control" id="zip_code" name="zip_code" value="{{ $contact->zip_code }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input maxlength="10" type="text" class="form-control" id="contact_phone" name="contact_phone" value="{{ $contact->contact_phone }}">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="contact_phone2">Contact Phone 2 <span style="color:red"></span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <input maxlength="10" type="text" class="form-control" id="contact_phone2" name="contact_phone2" value="{{ $contact->contact_phone2 }}">
                                @if($errors->has('contact_phone2'))
                                <strong class="text-danger">{{ $errors->first('contact_phone2') }}</strong>
                                @endif
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <label for="contact_mobile2">Contact Mobile2 <span style="color:red"></span></label>
                            </div>
                            <div class="col-md-4 mb-3">
                                <input maxlength="11" type="text" class="form-control" id="contact_mobile2" name="contact_mobile2" value="{{ $contact->contact_mobile2 }}">
                                @if($errors->has('contact_mobile2'))
                                <strong class="text-danger">{{ $errors->first('contact_mobile2') }}</strong>
                                @endif
                            </div>
                        </div>
                        <div class="form-row">
