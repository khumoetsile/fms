                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-2 col-md-2">
                            <a href="{{ route('messages.restore_bulk') }}" type="button" class="btn btn-block btn-sm btn-info" role="button">Restore All</a>
                        </div>
                        <div class="col-lg-2 col-md-2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('messages_restore/'.$message->message_id) }}" type="button" class="btn btn-sm btn-success btn-single-submit" role="button"><i class="fa fa-check"></i> Restore</a>

                                                <a href="" id="{{ $message->message_id }}" type="button" class="btn btn-sm btn-danger btn-single-submit sa-params" role="button"><i class="far fa-trash-alt"></i> Delete Permanent</a>
        ...
        swal({
            ...
            preConfirm: function() {
              return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: 'messages_permDelete/'+message_id,
                    type: 'post',
                    data: '',
                    dataType: 'json'
                })
