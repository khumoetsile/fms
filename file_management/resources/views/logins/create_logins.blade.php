    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Add Login</h4>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('logins.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('login_code') is-invalid @enderror" value="{{ old('login_code') }}" id="login_code" name="login_code" placeholder="Enter Login code..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('login_name') is-invalid @enderror" value="{{ old('login_name') }}" id="login_name" name="login_name" placeholder="Enter Login name..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" name="submit_logins" id="submit_logins" value="1">
