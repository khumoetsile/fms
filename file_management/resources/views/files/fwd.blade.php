    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Forward Document</h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Forward Document</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('fwd.fwd_update', $file->id) }}" method="get" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                         <div class="form-row">
                            <div class="col-md-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('from') is-invalid @enderror" id="from" name="from" value="{{ $from_user }}" readonly>
                                @if($errors->has('from'))
                         ...
                         <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                               <textarea rows="4", cols="54" class="form-control form-control-sm @error('route_purpose') is-invalid @enderror" value="{{ old('route_purpose') }}" id="route_purpose" name="route_purpose" placeholder="Enter Action Taken..." required></textarea>
