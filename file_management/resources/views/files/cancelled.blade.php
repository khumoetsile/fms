...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">Cancelled Document</h4>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Cancelled Document</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Cancelled Document</h4>
					<div class="row">
						<div class="col-12">
							@if(session('gmsg'))
                    ...
                    <form class="form-single-submit" action="{{ route('cancelled.cancelled_update', $file->id) }}" method="get" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-row">
                            <div class="col-md-3">
                                <label for="cancel_reason">Reasons To Cancel<span style="color:red"> *</span></label>
                            </div>
                                <div class="col-md-4 mb-3">
                                	<textarea rows="4", cols="54" class="form-control form-control-sm @error('cancel_reason') is-invalid @enderror" value="{{ old('cancel_reason') }}" id="cancel_reason" name="cancel_reason" placeholder="Enter Reason..." required></textarea>
                                </div>
                        </div>
                        <hr>
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                ...
                                <button type="submit" class="btn btn-block btn-sm btn-info btn-single-submit" >Cancelled</button>
                            </div>
                            <div class="col-md-2">
