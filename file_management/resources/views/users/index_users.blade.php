...
<div class="page-wrapper">
                    ...
                    <h4 class="card-title">Users</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2">
                                <a href="{{ route('users.create') }}" type="button" class="btn btn-block btn-sm btn-info" role="button">Add User</a>
                            </div>
                            <div class="col-lg-2 col-md-2">
                            ...
                            <div class="col-lg-2 col-md-2">
                                <a href="#" id="users_export" type="button" class="btn btn-block btn-sm btn-success btn-single-submit" role="button">Export Users</a>
                            </div>
    ...
    <script type="text/javascript">
       ...
       $('#check_all').change(function(){
        ...
        $(document).on('click', '#users_export', function(e){
              ...
              return new Promise(function(resolve) {
                ...
                .done(function(response){
                    swal('Exported!', response.message);
                           ...
                           window.location = "{{ route('users.export_csv') }}";
                        })
                .fail(function(){
