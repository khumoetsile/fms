        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('users.store_users') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('accounts_number') is-invalid @enderror" value="{{ $account->accounts_number }}" id="accounts_number" name="accounts_number" readonly>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('usercompany') is-invalid @enderror" value="{{ $account->accounts_company }}" id="usercompany" name="usercompany" readonly>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                <input type="hidden" minlength="8" maxlength="254" class="form-control form-control-sm @error('roles') is-invalid @enderror" value="Customer" id="roles" name="roles" >
                                @if($errors->has('roles'))
                                <strong class="text-danger">{{ $errors->first('roles') }}</strong>
                                @endif
                            </div>
                            <div class="col-md-4 mb-3">
                                <input type="hidden" minlength="8" maxlength="254" class="form-control form-control-sm @error('accounts_id') is-invalid @enderror" value="{{ $account->id }}" id="accounts_id" name="accounts_id" >
