        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('buildings.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('building_name') is-invalid @enderror" value="{{ old('building_name') }}" id="building_name" name="building_name" placeholder="Enter Building name..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" name="submit_buildings" id="submit_buildings" value="1">
