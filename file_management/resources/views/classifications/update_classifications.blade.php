                    ...
                    <form class="form-single-submit" action="{{ route('classifications.update', $classification->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('classification_code') is-invalid @enderror" id="classification_code" name="classification_code" value="{{ $classification->classification_code }}" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" style="text-transform:uppercase" maxlength="254" class="form-control form-control-sm @error('classification_name') is-invalid @enderror" id="classification_name" name="classification_name" value="{{ $classification->classification_name }}" required>
