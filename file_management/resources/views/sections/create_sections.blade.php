        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-single-submit" action="{{ route('sections.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="text" maxlength="254" class="form-control form-control-sm @error('section_name') is-invalid @enderror" value="{{ old('section_name') }}" id="section_name" name="section_name" placeholder="Enter Section name..." required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" name="submit_sections" id="submit_sections" value="1">
