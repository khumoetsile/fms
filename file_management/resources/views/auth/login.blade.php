            ...
            <div class="action-form col-5" style="background-color: rgba(0,0,0,0.5);">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <a class="text-white" href="{{ url('/') }}"><h3 class="text-white font-medium m-b-20">File Management System</h3></a>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right text-white">{{ __('Email/Username') }}</label>
