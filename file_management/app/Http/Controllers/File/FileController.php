...
class FileController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('files.create_files',compact('categories','classifications','reference_no','users','user','offices'));
    }
    ...
    public function edit(File $file)
    {
        ...
        return view('files.update_files',compact('file','categories','classifications','offices','users'));
    }
