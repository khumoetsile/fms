...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::group(['middleware' => ['role:SuperUser']], function() {
		...
		Route::get('/masters_upload_page','Master\MasterController@upload_page')->name('masters.upload_page');
		Route::post('/masters_csv_upload','Master\MasterController@upload_process')->name('masters.upload_process');
		Route::get('/masters_download_csv','Master\MasterController@download_sample_csv')->name('masters.download_csv');
		Route::get('/masters_export_csv','Master\MasterController@export_masters')->name('masters.export_csv');
		Route::post('/masters_bulk_delete','Master\MasterController@bulk_delet')->name('masters.bulk_delet');
		Route::get('/masters_restore/{id}','Master\MasterController@restore_single')->name('masters.restore_single');
		Route::get('/masters_bulk_restore','Master\MasterController@restore_bulk')->name('masters.restore_bulk');
		Route::get('/masters_deleted_show','Master\MasterController@show_deleted')->name('masters.show_deleted');
		Route::post('/masters_permDelete/{id}','Master\MasterController@perm_Delete');
		Route::post('/masters_bulk_permDelete','Master\MasterController@perm_bulk_delet');
		Route::post('/masters_check','Master\MasterController@check_masters')->name('check.masters');
		Route::post('/masters_get','Master\MasterController@get_masters')->name('get.masters');
