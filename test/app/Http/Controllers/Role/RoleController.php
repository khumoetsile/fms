...
class RoleController extends Controller
{
    ...
    {
        $this->middleware('permission:SuperAdmin-list|Admin-list|SuperAdmin-create|SuperAdmin-edit|SuperAdmin-delete', ['only' => ['index','store']]);
        ...
        $this->middleware('permission:SuperAdmin-delete',    ['only' => ['destroy']]);
    }
