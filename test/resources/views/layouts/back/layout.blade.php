...
<head>
    ...
    <link href="{{ asset('back/css/app_custom.css') }}" rel="stylesheet" media="print">
    ...
    <link href="{{ asset('back/css/print.css') }}" rel="stylesheet" type="text/css" media="print">
...
<script src="{{ asset('back/libs/jquery.repeater/jquery.repeater.min.js') }}"></script>
<script src="{{ asset('back/extra-libs/jquery.repeater/repeater-init.js') }}"></script>
<script src="{{ asset('back/extra-libs/jquery.repeater/dff.js') }}"></script>
<!--chartis chart-->
